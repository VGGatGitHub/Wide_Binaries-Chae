# This python class generates one Monte Carlo set of acceleration data (vtilde[:=v_p/v_c], s/r_M) for an input sample of wide binaries and returns the median residuals in the user-defined bins.
...
class vtilde_wb_v5:
    ...
    def run_mc(self,mod='g',echoice='i',Gboost=1.):        
        ...
        Mtot = M_A+M_B
        r_M = np.sqrt(G*Mtot*Msun/1.2e-10)/(1000*au)
        ...
        return running_median_x, running_median_y, running_median_y_err,running_sample_n
